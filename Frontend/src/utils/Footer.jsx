      ...
      <Container as={Stack} maxW={"6xl"} py={10}>
        ...
        >
          <Stack spacing={6}>
            ...
            <br />
            <Text fontSize={"sm"}>
              cultsport offers top quality, best in class products which provide
              a holistic approach to fitness - combining fitness products with
              best in class fitness content, features, coaching & service
            </Text>
          </Stack>
